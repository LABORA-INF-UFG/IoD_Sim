...
plt.subplot(1, 3, 2)
plt.plot(ram_usage, drone_amounts, marker='o', linestyle='-', color='tab:blue', label='E-IoD-Sim Process')
...
plt.subplot(1, 3, 1)
plt.plot(elapsed_time, drone_amounts, marker='o', linestyle='-', color='tab:blue', label='Real Time')
plt.plot([60, 60, 60, 60, 60, 60], drone_amounts, linestyle='--', color='tab:orange', label='Simulated Time')
plt.ylabel('Number of Drones')
...
plt.subplot(1, 3, 3)
plt.plot(system_cpu_usage, drone_amounts, marker='o', linestyle='-', color='tab:blue', label='System')
plt.plot(process_cpu_usage, drone_amounts, marker='o', linestyle='-', color='tab:orange', label='E-IoD-Sim Process')
#plt.ylabel('Number of Drones')
